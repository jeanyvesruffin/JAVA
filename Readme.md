...
* Les collections
* Les exceptions
* Les entrées/ sorties (buffer, stream)
* Implémentation classe sérialisée
* Classe et implémentation génériques
* Interface graphique SWING
* Accès aux base de donnée JDBC
* Programmation réseaux par sockets + Thread et multiThread
* Programmation distribué RMI
* MiddleWare RMI
* Architecture JNDI
